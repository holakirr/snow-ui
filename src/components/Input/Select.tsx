...
const SelectContent: FC<SelectContentProps> = ({
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      className={twMerge(
        'relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-2xl border border-black/10 bg-white/80 backdrop-blur-2xl text-black data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 touch-manipulation sm:touch-auto',
        position === 'popper' &&
